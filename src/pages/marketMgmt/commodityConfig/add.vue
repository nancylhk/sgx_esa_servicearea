	...
	<div class="app-form mt20 ml40">
		...
		<el-form :model="addInfo" :rules="rules" ref="addInfo" label-width="110px" size="mini">
			<div class="mt30">
				...
				<el-form-item label="商品名称：" prop="commodityName" class="form-right">
					<el-input v-model="addInfo.commodityName"></el-input>
				</el-form-item>
			...
			<div class="mt30">
				...
				<el-form-item label="库存上限：" prop="stockTopLimit" class="form-right">
				...
				<el-form-item label="是否打印杯贴：" prop="isPrint"  class="inbk">
